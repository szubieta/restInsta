...
class Publicacion(models.Model):
    ...
    fecha_editado = models.DateTimeField(verbose_name = 'fecha editado', auto_now = True)
    fecha_publicado = models.DateTimeField(verbose_name = 'fecha publicado', auto_now_add = True)
